		...
		<div class="row">
					...
					<div class="row">
						...
						<div class="col-lg-9 image_col order-lg-2 order-1">
							<div class="single_product_image">
								...
								<div class="single_product_image_background" style="background-image:url(<?=base_url(); ?>assets/images/<?= $item[0]['fotodepan']?>)"></div>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="col-lg-5">
				<div class="product_details">
                    ...
                    <!-- <h2>Pocket cotton sweatshirt</h2> -->
						...
						<div class="row">
							<div class="col additional_info_col">
								<p>Jenis:<span><?= $item[0]['jenis']?></span></p>
								<p>Merk:<span><?= $item[0]['merk']?></span></p>
								<p>Model:<span><?= $item[0]['model']?></span></p>
								<p>Volume Mesin:<span><?= $item[0]['volume_mesin']?></span></p>
								<p>Transmisi:<span><?= $item[0]['transmisi']?></span></p>
								<p>Bahan Bakar:<span><?= $item[0]['bahanbakar']?></span></p>
								<p>Warna:<span><?= $item[0]['warna']?></span></p>
								<p>Tahun:<span><?= $item[0]['tahun']?></span></p>
								<!-- <p>nopol:<span><?= $item[0]['nopol']?></span></p> -->
								<p>KM :<span><?= $item[0]['kilometer']?></span></p>
							</div>
							<div class="col additional_info_col">
								<p>AC:<span><?= $item[0]['ac']?></span></p>
								<p>Power Steering:<span><?= $item[0]['powersteering']?></span></p>
								<p>Power Window :<span><?= $item[0]['powerwindow']?></span></p>
								<p>Central Lock:<span><?= $item[0]['centrallock']?></span></p>
								<p>Alarm:<span><?= $item[0]['alarm']?></span></p>
								<p>Kondisi:<span><?= $item[0]['kondisi']?></span></p>
								<p>Deskripsi:<span><?= $item[0]['deskripsi']?></span></p>
					...
					<div class="product_price">Rp.<?= $item[0]['harga']?></div>
