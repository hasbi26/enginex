...
<head>
	...
	<title>Single Product Aksesoris</title>
</head>
...
<body>
	...
	<div class="imageBox">
		<div class="swiper mySwiper">
			<div class="swiper-wrapper">
				<div class="swiper-slide"><img class="d-block w-100  image-modal-trigger" src="<?= base_url(); ?>assets/images/<?= $param ?>/<?= $item[0]['namaItem'] ?>/<?= $item[0]['foto1'] ?>" alt="First slide"></div>
				<div class="swiper-slide"><img class="d-block w-100  image-modal-trigger" src="<?= base_url(); ?>assets/images/<?= $param ?>/<?= $item[0]['namaItem'] ?>/<?= $item[0]['foto2'] ?>" alt="First slide"></div>
				<div class="swiper-slide"><img class="d-block w-100  image-modal-trigger" src="<?= base_url(); ?>assets/images/<?= $param ?>/<?= $item[0]['namaItem'] ?>/<?= $item[0]['foto3'] ?>" alt="First slide"></div>
			</div>
  ...
  <div class="modal-dialog">
	...
	<!-- <h1 class="detailHeading">Mazda Vantrend 1995</h1> -->
		<h1 class="detailHeading"><?= $item[0]['merk'].' '.$item[0]['namaItem'] ?></h1>
		...
		<div class="row">
			...
			<div class="col-6">
				...
				<a href="https://wa.me/+6281324962776?text=Saya%20ingin%20pesan%20:%0A<?= $item[0]['merk'] ?>%20<?= $item[0]['namaItem'] ?>Harga:%20<?= $item[0]['harga'] ?>" class="btn btn-xs btn-block">Pesan</a>
